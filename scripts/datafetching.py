...
class data_fetcher:
    ...
    def __init__(self, public_data_url = "https://s3-us-west-2.amazonaws.com/usgs-lidar-public/", pipeline_json_path="./pipe_temp.json") -> None:
      
        ''' this is a constructor method to initiialize the functions that are going to be implemented today  '''
        self.Logger = Logger().get_logger(__name__)
        self.helper = helper()
        self.pipeline_json = self.helper.read_json(pipeline_json_path)
